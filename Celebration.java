...
public class Celebration implements Celebratable {
	...
	public Celebration(Creature hero1, Creature hero2) {
		this.hero1 = hero1;
		this.hero2 = hero2;
		place = "в незаданном месте";
	}	
	public Celebration(Creature hero1, Creature hero2, String place) {
		this.hero1 = hero1;
		this.hero2 = hero2;
		this.place = place;
	}
	public void celebrateTogether(Time time) {
		...
		System.out.println("Время " + time.getTime() + " на территории " + hero1.getLocation().getFullAdress() + " словно специально созданы для празднования дней рождения именинника по имени " + hero2.getName() + ", которому исполнилось " + hero2.getAge() +" лет.");
	}
	...
	public void eatTogether(FoodAndDrinks food){
		if (isSittingTogether) {
			...
			System.out.println(hero1.getName() + " и " +  hero2.getName() + " не могут кушать вместе.");
		}
	}
	public void drinkTogether(FoodAndDrinks drink) {
		if (isSittingTogether) {
			...
			System.out.println(hero1.getName() + " и " +  hero2.getName() + " не могут пить вместе.");
		}
	}
